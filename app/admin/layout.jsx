    ...
    <div className="min-h-screen bg-background flex">
      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
          ...
          <Link
            href="/"
            onClick={() => setSidebarOpen(false)}
            className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-muted-foreground hover:bg-white/[0.05] hover:text-foreground transition-all"
          >
      ...
      <div className="flex flex-1 flex-col min-w-0">
        <header className="sticky top-0 z-20 flex items-center gap-3 border-b border-white/[0.07] bg-background/80 backdrop-blur-xl px-4 py-3 lg:hidden">
          ...
          <Link href="/" className="ml-auto text-xs text-muted-foreground hover:text-foreground flex items-center gap-1 mr-2">
