        ...
        >
          ...
          <a href="#top" className="flex items-center gap-3">
            ...
            <div className="leading-none">
              ...
              {/* was text-[10px] — bumped to text-xs, brighter color */}
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Desktop Register — deep-blue → mid-blue, updated from old purple */}
            <a
              href="/register"
      ...
      {open && (
        <div className="fixed left-6 right-6 top-24 z-40 rounded-3xl border border-[#3d6bff]/20 bg-[#0d1635]/90 p-5 backdrop-blur-3xl lg:hidden">
          <ul className="space-y-1">
            ...
            <li className="pt-3">
              {/* Mobile Register — updated from amber/orange + black text */}
              <a
                href="/register"
                onClick={() => setOpen(false)}
